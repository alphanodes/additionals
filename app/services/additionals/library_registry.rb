...
module Additionals
  ...
  module LibraryRegistry
    ...
    ATOMS = {
      _chartjs_core_umd:       Asset.new(type: :js,  path: 'chart.umd'),
      _chartjs_core_min:       Asset.new(type: :js,  path: 'chart.min', core: true),
      _chartjs_colorschemes:   Asset.new(type: :js,  path: 'chartjs-plugin-colorschemes.min'),
      _chartjs_datalabels:     Asset.new(type: :js,  path: 'chartjs-plugin-datalabels.min'),
      _chartjs_annotation:     Asset.new(type: :js,  path: 'chartjs-plugin-annotation.min'),
      _moment_with_locales:    Asset.new(type: :js,  path: 'moment-with-locales.min'),
      _chartjs_adapter_moment: Asset.new(type: :js,  path: 'chartjs-adapter-moment.min'),
      _chartjs_chart_matrix:   Asset.new(type: :js,  path: 'chartjs-chart-matrix.min'),
      _d3plus_min:             Asset.new(type: :js,  path: 'd3plus.min'),
      _sortable_min:           Asset.new(type: :js,  path: 'sortable.min'),
      _actioncable_core:       Asset.new(type: :js,  path: 'actioncable', core: true),
      _mermaid_min:            Asset.new(type: :js,  path: 'mermaid.min'),
      _mermaid_load:           Asset.new(type: :js,  path: 'mermaid_load'),
      _select2_js:             Asset.new(type: :js,  path: 'select2.min'),
      _select2_helpers:        Asset.new(type: :js,  path: 'select2_helpers'),
      _dhtmlxgantt_js:         Asset.new(type: :js,  path: 'dhtmlxgantt'),
