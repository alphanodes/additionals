module Additionals
  class AdditionalsHookListener < Redmine::Hook::ViewListener
    ...
    render_on(:view_issues_sidebar_issues_bottom, partial: 'additionals_sidebar_issues')
    render_on(:view_issues_sidebar_queries_bottom, partial: 'additionals_sidebar_queries')
