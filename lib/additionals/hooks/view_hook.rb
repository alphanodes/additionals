...
module Additionals
  module Hooks
    class ViewHook < Redmine::Hook::ViewListener
      ...
      render_on :view_issues_show_details_bottom, partial: 'issues/additionals_show_details_bottom'
      render_on :view_issues_context_menu_start, partial: 'context_menus/additionals_closed_issues'
